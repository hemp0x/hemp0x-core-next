...
//        std::cout << "Failed: Hash is " << hashString << " but should be " << outString << std::endl;
    ...
    BOOST_AUTO_TEST_CASE(sha256_testvectors_test)
    {
        ...
        TestSHA256("As Hemp0x relies on 80 byte header hashes, we want to have an example for that.",
                   "ce312cad6b48fe44a7c89ce13c18dda67db184113b1e1664a40b8f082211a549");
