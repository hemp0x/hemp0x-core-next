...
The Hemp0x Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Tests* for changes to the hemp0x unit tests or QA tests
...
The following applies to code changes to the Hemp0x project (and related
projects) and is not to be confused with overall Hemp0x
Network Protocol consensus changes.

Whether a pull request is merged into Hemp0x rests with the project merge
...
Patches that change Hemp0x consensus rules are considerably more involved than
...
Where a patch set proposes to change the Hemp0x consensus, it must have been
