...
#ifndef HEMP0X_CHAINPARAMS_H
#define HEMP0X_CHAINPARAMS_H
 ...
 * Hemp0x system. There are three: the main network on which people trade goods
...
public:
    ...
    /** Whether this network exposes regtest-only controls for deterministic test scenarios */
