...
class TestHemp0xCli(Hemp0xTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `hemp0x-cli getinfo`")
        ...
        self.log.info("Compare responses from `hemp0x-cli -getinfo` and the RPCs data is retrieved from.")
