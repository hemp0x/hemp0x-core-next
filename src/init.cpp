...
static bool CreateDefaultConfigFile(fs::path pathConfigFile, std::string& error)
{
    ...
    const std::string contents =
        ...
        "# Command-line options override values set here.\n"
        "#\n"
        "# RPC authentication uses a local cookie by default. For static RPC\n"
        "# credentials, prefer rpcauth generated by share/rpcuser/rpcuser.py.\n"
        "#\n"
        "# server=1 enables JSON-RPC for local tools such as hemp0x-cli.\n"
        "#server=1\n"
        "#rpcbind=127.0.0.1\n"
        "#rpcallowip=127.0.0.1\n"
        "#\n"
        "# txindex=1 maintains a full transaction index. Explorers and indexers\n"
        "# commonly need this, but ordinary wallet nodes usually do not.\n"
        "#txindex=1\n"
        "#\n"
