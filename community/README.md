...
* Core
    * Asset Exchange Proxy (simulate sending an ASSET like hemp0xd does for HEMP)
...
* Run a contest: HEMP prize for best idea for new Hemp0x based Business
...
* Back-end API platform for Hemp0x
    * Other people to hit high-availablity API
* Fee system to pay HEMP fees automatically
    * Auto-pay fees
    * Can take X% of fees
...
* Auto fee funder (so users of ABC token doesn’t need to worry about fees)
    ...
    * Sends small amount of HEMP for fees.
...
* #KYC tagger - store info and tag Hemp0x addresses
* #ACCREDITED - verify accredited status and tag Hemp0x addresses
 
### Technical Consultant
* Help companies apply Hemp0x capabilities to real-world problems
* Security Token Issuance Platform
* Collaborate with exchanges for more listings
* Collaborate with custodial Security Token exchanges for deposit/withdrawal
* Collaborate with hardware wallets for additional HEMP and asset support


### Areas for Hemp0x Innovation
* Financial
