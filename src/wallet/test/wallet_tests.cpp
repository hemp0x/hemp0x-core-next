...
BOOST_FIXTURE_TEST_SUITE(wallet_tests, WalletTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(coin_selection_test)
    {
        ...
        for (int i = 0; i < RUN_TESTS; i++)
        {
            ...
            BOOST_CHECK_EQUAL(nValueRet, 1 * COIN);  // we should get 1 HEMP in 1 coin
            BOOST_CHECK_EQUAL(setCoinsRet.size(), 1U);

            BOOST_CHECK(testWallet.SelectCoinsMinConf(195 * CENT, 1, 1, 0, vCoins, setCoinsRet, nValueRet));
            BOOST_CHECK_EQUAL(nValueRet, 2 * COIN);  // we should get 2 HEMP in 1 coin
            BOOST_CHECK_EQUAL(setCoinsRet.size(), 1U);
    ...
    BOOST_FIXTURE_TEST_CASE(rescan_test, TestChain100Setup)
    {
        ...
        // file.
        {
            ...
            BOOST_CHECK_EQUAL(wallet.GetImmatureBalance(), 10 * COIN);
        }
        ...
        // after.
        {
            ...
            BOOST_CHECK_EQUAL(response.write(),
                              strprintf("[{\"success\":false,\"error\":{\"code\":-1,\"message\":\"Rescan failed for key with creation "
                                        ...
                                        "by pruning or data corruption (see hemp0xd log for details) and could be dealt with by "
...
// debit functions.
    BOOST_FIXTURE_TEST_CASE(coin_mark_dirty_immature_credit_test, TestChain100Setup)
    {
        ...
        wtx.MarkDirty();
        wallet.AddKeyPubKey(coinbaseKey, coinbaseKey.GetPubKey());
        BOOST_CHECK_EQUAL(wtx.GetImmatureCredit(), 10 * COIN);
    }
...
// expanded to cover more corner cases of smart time logic.
    ...
    BOOST_FIXTURE_TEST_CASE(ListCoins_test, ListCoinsTestingSetup)
    {
        ...
        BOOST_CHECK_EQUAL(10 * COIN, wallet->GetAvailableBalance());
