...
//    { "createrawtransaction", 3, "replaceable" },
    ...
    { "exportwalletmigration", 1, "include_private"},
    { "exportwalletmigration", 2, "allow_overwrite"},
    { "restorewalletmigration", 3, "birth_height"},
    ...
    { "rescanmessages", 0, "start_height"},
    { "rescanmessages", 1, "stop_height"},
    { "viewallmessages", 0, "count"},
    { "viewallmessages", 1, "offset"},
    { "viewallmessages", 3, "start_height"},
    { "viewallmessages", 4, "stop_height"},
    { "viewchannelmessages", 1, "count"},
    { "viewchannelmessages", 2, "offset"},
    { "viewchannelmessages", 3, "start_height"},
    { "viewchannelmessages", 4, "stop_height"},
    { "viewindexedmessagechannels", 1, "count"},
    { "viewindexedmessagechannels", 2, "offset"},
