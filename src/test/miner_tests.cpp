...
BOOST_FIXTURE_TEST_SUITE(miner_tests, TestingSetup)
    ...
    struct BootstrapFixture
    {
        ...
        unsigned int nNonce;
        unsigned int nNonce64;
        uint256 expectedHashPrevBlock;
        uint256 expectedHash;
    } bootstrapFixture[] = {
            {1766119733, 1, 2109715, 2109715,
                    uint256S("0000009907c43e63467860fcb2a76eed0200e4f918de00bfea3fa35aa22dddd0"),
                    uint256S("000000aa2381ae558fb737d7d216ac1fe6d6b7065e057281fb9e11c80df2b818")},
            {1766119734, 1, 1878879, 1878879,
                    uint256S("000000aa2381ae558fb737d7d216ac1fe6d6b7065e057281fb9e11c80df2b818"),
                    uint256S("000007b151fc7637703f4e27c4514ee4b20c67e6163a7360c53645e6f20ac5be")},
            {1766119734, 1, 99418, 99418,
                    uint256S("000007b151fc7637703f4e27c4514ee4b20c67e6163a7360c53645e6f20ac5be"),
                    uint256S("0000035d7efd2e9428531f440acfdeb5aba8fdd5dd1164def98bcf787ad8a424")},
            {1766119735, 1, 3454768, 3454768,
                    uint256S("0000035d7efd2e9428531f440acfdeb5aba8fdd5dd1164def98bcf787ad8a424"),
                    uint256S("00000e7b4fe39b559d3770eea2af737371c14f5db413799d397bc2f8ab1ee71f")},
    };

    static std::shared_ptr<const CBlock> ProcessBootstrapFixtureBlock(
            ...
            const BootstrapFixture& fixture)
    {
        ...
        block.nVersion = 1;
        block.nTime = fixture.nTime;
        block.nNonce = fixture.nNonce;
        block.nNonce64 = fixture.nNonce64;
        ...
        unsigned int extraNonce = fixture.nExtraNonce - 1;
        IncrementExtraNonce(&block, chainActive.Tip(), extraNonce);
        BOOST_CHECK(block.hashPrevBlock == fixture.expectedHashPrevBlock);
        BOOST_CHECK(block.GetHash() == fixture.expectedHash);

        std::shared_ptr<const CBlock> shared_pblock = std::make_shared<const CBlock>(block);
        BOOST_REQUIRE(ProcessNewBlock(chainparams, shared_pblock, true, nullptr));
        return shared_pblock;
    }
    ...
    void TestPackageSelection(const CChainParams &chainparams, CScript scriptPubKey, std::vector<CTransactionRef> &txFirst)
    {
        ...
        tx.vout[1].nValue = 100000000; // 1HEMP output
    ...
    BOOST_AUTO_TEST_CASE(createnewblock_validity_test)
    {
        ...
        // The currently reachable part of this test only retains the first four
        // coinbases before the early return below.
        int baseheight = 0;
        std::vector<CTransactionRef> txFirst;

        for (const BootstrapFixture& fixture : bootstrapFixture)
        {
            std::shared_ptr<const CBlock> shared_pblock = ProcessBootstrapFixtureBlock(chainparams, scriptPubKey, fixture);
            if (txFirst.size() == 0)
                baseheight = chainActive.Height();
            if (txFirst.size() < 4)
                txFirst.push_back(shared_pblock->vtx[0]);
        }
