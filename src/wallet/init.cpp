...
std::string GetWalletHelpString(bool showDebug)
{
    ...
    strUsage += HelpMessageOpt("-walletnotify=<cmd>", _("Execute shell command when a wallet transaction changes (%s in cmd is replaced by TxID; only use trusted commands)"));
