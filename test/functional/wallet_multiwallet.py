...
Verify that a hemp0xd node can load multiple wallet files
"""
import os
import shutil
...
class MultiWalletTest(Hemp0xTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(w1_info['immature_balance'], 10)
